...
- verify-references caught 2 issues in initial build: "Kosmyna et al. (2026)" (was 2025; arXiv:2506.08872 is June 2025) and "Jin et al. ~27% via flawed reasoning" (was 35.5% flawed reasoning; 27% was the image-comprehension errors figure). Both fixed.
- A subsequent expansion of Sub-Lesson 9.1 added a "What Benchmarks Don't Tell You" section covering Goodhart's Law (Strathern's 1997 formulation of Goodhart's 1975 principle), benchmark contamination (Deng et al. 2023, arXiv:2311.09783, with the 52%/57% MMLU TS-Guessing finding), FrontierMath's held-out Tier 4 design as a contamination response, and the African / low-resource language coverage gap (Alhanai et al. AAAI 2025, *Bridging the Gap*, arXiv:2412.12417; AfroBench at ACL 2025; IrokoBench arXiv:2406.03368; MMLU-ProX). verify-references caught 3 errors in the new section before commit: wrong first author for the contamination paper (Zhou → Deng), wrong author attribution for *Bridging the Gap* (Adelani → Alhanai et al.), and an unverified "~45 percentage points" claim (softened to documented "previously unknown performance gaps" with the verified 5.6%/2.9% improvement figures from the paper itself). All three fixed before commit.
